...
<div class="tuition-sales-page" data-update-base="{{ $updateRouteBase }}">
    ...
    <div class="page-header">
        <div>
            <h1>スポット売上</h1>
            <p>スポット売上の取引予定日、取引日、入出金方法、割引を確認します。</p>
        </div>
    </div>
    ...
    <section class="tuition-create-card">
        ...
        <form method="POST" action="{{ route('admin.operations.classroom-accounting.spot-sales.store') }}">
            @csrf
        ...
        <form method="GET" action="{{ route('admin.operations.classroom-accounting.spot-sales.index') }}">
            ...
            <div class="tuition-search-row tuition-search-row-last">
                ...
                <div class="tuition-search-actions">
                    ...
                    <a href="{{ route('admin.operations.classroom-accounting.spot-sales.index') }}" class="tuition-clear-button">
                        クリア
                    </a>

                    @if ($exportRouteExists)
                        <a href="{{ route('admin.operations.classroom-accounting.spot-sales.export', request()->query()) }}" class="tuition-export-button">
                            CSV出力
                        </a>
                    @endif
