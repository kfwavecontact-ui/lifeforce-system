...
<div class="tuition-sales-page" data-update-base="{{ $updateRouteBase }}">
    ...
    <section class="tuition-create-card">
        ...
        <form method="POST" action="{{ route('admin.operations.classroom-accounting.expenses.store') }}">
            @csrf
    ...
    <section class="tuition-search-area">
        <form method="GET" action="{{ route('admin.operations.classroom-accounting.expenses.index') }}">
            ...
            <div class="tuition-search-row tuition-search-row-last">
                ...
                <div class="tuition-search-actions">
                    ...
                    <a href="{{ route('admin.operations.classroom-accounting.expenses.index') }}" class="tuition-clear-button">
                        クリア
                    </a>

                    @if ($exportRouteExists)
                        <a href="{{ route('admin.operations.classroom-accounting.expenses.export', request()->query()) }}" class="tuition-export-button">
                            CSV出力
                        </a>
                    @endif
