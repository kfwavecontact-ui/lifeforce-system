...
<div class="tuition-sales-page" data-update-base="{{ $updateRouteBase }}">
    ...
    <div class="page-header">
        <div>
            <h1>返金</h1>
            <p>返金の予定日、返金日、返金方法、返金理由を確認します。</p>
        </div>
    </div>
    ...
    <section class="tuition-create-card">
        ...
        <form method="POST" action="{{ route('admin.operations.classroom-accounting.refunds.store') }}">
            @csrf
    ...
    <section class="tuition-search-area">
        <form method="GET" action="{{ route('admin.operations.classroom-accounting.refunds.index') }}">
            ...
            <div class="tuition-search-row tuition-search-row-last">
                ...
                <div class="tuition-search-actions">
                    ...
                    <a href="{{ route('admin.operations.classroom-accounting.refunds.index') }}" class="tuition-clear-button">
                        クリア
                    </a>

                    @if ($exportRouteExists)
                        <a href="{{ route('admin.operations.classroom-accounting.refunds.export', request()->query()) }}" class="tuition-export-button">
                            CSV出力
                        </a>
                    @endif
