...
@php
    ...
    $exportRouteExists = Route::has('admin.operations.classroom-accounting.tuition-enrollment-sales.export');
    $updateRouteBase = url('/admin/operations/classroom-accounting/tuition-enrollment-sales');
@endphp
...
<div class="tuition-sales-page" data-update-base="{{ $updateRouteBase }}">
    ...
    <div class="page-header">
        <div>
            <h1>授業料・入会金売上</h1>
            <p>授業料・入会金の売上、取引予定日、取引日、入出金方法、割引を確認します。</p>
        </div>
    </div>
    ...
    <section class="tuition-create-card">
        <div class="tuition-create-header">
            <h3>新規取引登録</h3>
            <p>授業料・入会金売上を簡単に登録します。</p>
        </div>

        <form method="POST" action="{{ route('admin.operations.classroom-accounting.tuition-enrollment-sales.store') }}">
            @csrf
    ...
    <section class="tuition-search-area">
        <form method="GET" action="{{ route('admin.operations.classroom-accounting.tuition-enrollment-sales.index') }}">
            ...
            <div class="tuition-search-row tuition-search-row-last">
                ...
                <div class="tuition-search-actions">
                    ...
                    <a href="{{ route('admin.operations.classroom-accounting.tuition-enrollment-sales.index') }}" class="tuition-clear-button">
                        クリア
                    </a>

                    @if ($exportRouteExists)
                        <a href="{{ route('admin.operations.classroom-accounting.tuition-enrollment-sales.export', request()->query()) }}" class="tuition-export-button">
                            CSV出力
                        </a>
                    @endif
