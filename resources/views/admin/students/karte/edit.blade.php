    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.students.karte.update', $student) }}">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label>通塾曜日</label>
                    <input type="text" name="commute_days" value="{{ old('commute_days', $student->commute_days) }}">
                </div>

                <div class="form-group full">
                    <label>備考</label>
                    <textarea name="remarks" rows="5">{{ old('remarks', $student->remarks) }}</textarea>
                </div>

            </div>

            <div class="form-actions">
                <a href="{{ route('admin.students.karte.show', $student) }}" class="btn btn-outline">
                    戻る
                </a>
